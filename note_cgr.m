...
zz1=[linspace(0,1.5,8192*(1/8)*(2/8)),linspace(1.5,1,8192*(1/8)*(1/8)),linspace(1,1,8192*(1/8)*(4/8)),linspace(1,0,8192*(1/8)*(1/8))]  %zz1'de zarfın pozitif kısmını çizdirdir
                                                                                                                                       %başlangıç değeri,bitiş değeri,Fs*vurus*t degisimi formülüyele zarfın zz1'de pozitif kısmını çizdirdim.
   plot(y,zz1)
    
zz2=[linspace(0,-1.5,8192*(1/8)*(2/8)),linspace(-1.5,-1,8192*(1/8)*(1/8)),linspace(-1,-1,8192*(1/8)*(4/8)),linspace(-1,0,8192*(1/8)*(1/8))]  %zz2'de zarfın pozitif kısmını çizdirdiö
